...
fun DetailScreen(
    ...
    Scaffold(
        topBar = {
            ...
            FloatingActionButton(
                onClick = { navigateToEditItem(uiState.value.addEvent.setoranID) },
...
private fun ItemDetailsBody(
    ...
    Column(
        ...
        ItemDetails(
            setoranData  = detailUIState.addEvent.toSetoranData(), modifier = Modifier.fillMaxWidth()
        )
...
@Composable
fun ItemDetails(
    setoranData: SetoranData, modifier: Modifier = Modifier
) {
    Card(
        ...
        Column(
            ...
            ItemDetailsRow(
                labelResID ="Halaman",
                itemDetail = setoranData.halaman,
                modifier = Modifier.padding(
                    horizontal = 12.dp
                )
            )
